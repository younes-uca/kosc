...
@Component({
    selector: 'app-template-email-confirmation-client-list-chercheur',
    templateUrl: './template-email-confirmation-client-list-chercheur.component.html',
    styleUrls: ['./template-email-confirmation-client-list-chercheur.component.css']
})
export class TemplateEmailConfirmationClientListChercheurComponent implements OnInit {
    // declarations
