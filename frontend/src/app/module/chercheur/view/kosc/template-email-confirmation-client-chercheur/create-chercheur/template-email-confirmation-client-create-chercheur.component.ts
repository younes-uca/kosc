...
@Component({
    selector: 'app-template-email-confirmation-client-create-chercheur',
    templateUrl: './template-email-confirmation-client-create-chercheur.component.html',
    styleUrls: ['./template-email-confirmation-client-create-chercheur.component.css']
})
export class TemplateEmailConfirmationClientCreateChercheurComponent implements OnInit {
