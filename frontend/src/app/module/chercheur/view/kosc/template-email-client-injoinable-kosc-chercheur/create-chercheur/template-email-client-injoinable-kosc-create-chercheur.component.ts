...
@Component({
    selector: 'app-template-email-client-injoinable-kosc-create-chercheur',
    templateUrl: './template-email-client-injoinable-kosc-create-chercheur.component.html',
    styleUrls: ['./template-email-client-injoinable-kosc-create-chercheur.component.css']
})
export class TemplateEmailClientInjoinableKoscCreateChercheurComponent implements OnInit {
