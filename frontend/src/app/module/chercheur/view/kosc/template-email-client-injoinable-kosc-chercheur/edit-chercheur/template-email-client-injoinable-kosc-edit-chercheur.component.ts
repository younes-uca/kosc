...
@Component({
    selector: 'app-template-email-client-injoinable-kosc-edit-chercheur',
    templateUrl: './template-email-client-injoinable-kosc-edit-chercheur.component.html',
    styleUrls: ['./template-email-client-injoinable-kosc-edit-chercheur.component.css']
})
export class TemplateEmailClientInjoinableKoscEditChercheurComponent implements OnInit {
