...
@Component({
    selector: 'app-template-email-cri-list-chercheur',
    templateUrl: './template-email-cri-list-chercheur.component.html',
    styleUrls: ['./template-email-cri-list-chercheur.component.css']
})
export class TemplateEmailCriListChercheurComponent implements OnInit {
    // declarations
