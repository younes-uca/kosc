...
@Component({
    selector: 'app-template-email-mauvais-contact-view-chercheur',
    templateUrl: './template-email-mauvais-contact-view-chercheur.component.html',
    styleUrls: ['./template-email-mauvais-contact-view-chercheur.component.css']
})
export class TemplateEmailMauvaisContactViewChercheurComponent implements OnInit {
