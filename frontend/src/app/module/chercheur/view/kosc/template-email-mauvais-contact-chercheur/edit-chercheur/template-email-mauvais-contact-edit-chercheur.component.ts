...
@Component({
    selector: 'app-template-email-mauvais-contact-edit-chercheur',
    templateUrl: './template-email-mauvais-contact-edit-chercheur.component.html',
    styleUrls: ['./template-email-mauvais-contact-edit-chercheur.component.css']
})
export class TemplateEmailMauvaisContactEditChercheurComponent implements OnInit {
