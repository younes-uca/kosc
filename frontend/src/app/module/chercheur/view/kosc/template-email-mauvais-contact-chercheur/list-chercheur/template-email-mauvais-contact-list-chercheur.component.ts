...
@Component({
    selector: 'app-template-email-mauvais-contact-list-chercheur',
    templateUrl: './template-email-mauvais-contact-list-chercheur.component.html',
    styleUrls: ['./template-email-mauvais-contact-list-chercheur.component.css']
})
export class TemplateEmailMauvaisContactListChercheurComponent implements OnInit {
    // declarations
