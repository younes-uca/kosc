...
@Component({
    selector: 'app-template-email-mauvais-contact-create-chercheur',
    templateUrl: './template-email-mauvais-contact-create-chercheur.component.html',
    styleUrls: ['./template-email-mauvais-contact-create-chercheur.component.css']
})
export class TemplateEmailMauvaisContactCreateChercheurComponent implements OnInit {
