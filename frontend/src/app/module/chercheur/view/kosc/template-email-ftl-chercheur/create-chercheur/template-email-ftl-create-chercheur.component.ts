...
@Component({
    selector: 'app-template-email-ftl-create-chercheur',
    templateUrl: './template-email-ftl-create-chercheur.component.html',
    styleUrls: ['./template-email-ftl-create-chercheur.component.css']
})
export class TemplateEmailFtlCreateChercheurComponent implements OnInit {
