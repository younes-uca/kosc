...
@Component({
    selector: 'app-template-email-ftl-edit-chercheur',
    templateUrl: './template-email-ftl-edit-chercheur.component.html',
    styleUrls: ['./template-email-ftl-edit-chercheur.component.css']
})
export class TemplateEmailFtlEditChercheurComponent implements OnInit {
