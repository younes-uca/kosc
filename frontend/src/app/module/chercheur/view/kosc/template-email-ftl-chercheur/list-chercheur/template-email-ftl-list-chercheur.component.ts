...
@Component({
    selector: 'app-template-email-ftl-list-chercheur',
    templateUrl: './template-email-ftl-list-chercheur.component.html',
    styleUrls: ['./template-email-ftl-list-chercheur.component.css']
})
export class TemplateEmailFtlListChercheurComponent implements OnInit {
    // declarations
