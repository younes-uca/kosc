...
@Component({
    selector: 'app-template-email-ftl-view-chercheur',
    templateUrl: './template-email-ftl-view-chercheur.component.html',
    styleUrls: ['./template-email-ftl-view-chercheur.component.css']
})
export class TemplateEmailFtlViewChercheurComponent implements OnInit {
