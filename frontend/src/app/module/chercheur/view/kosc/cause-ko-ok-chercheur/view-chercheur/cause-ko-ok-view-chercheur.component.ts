...
@Component({
    selector: 'app-cause-ko-ok-view-chercheur',
    templateUrl: './cause-ko-ok-view-chercheur.component.html',
    styleUrls: ['./cause-ko-ok-view-chercheur.component.css']
})
export class CauseKoOkViewChercheurComponent implements OnInit {
