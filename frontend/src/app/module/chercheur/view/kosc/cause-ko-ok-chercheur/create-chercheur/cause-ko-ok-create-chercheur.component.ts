...
@Component({
    selector: 'app-cause-ko-ok-create-chercheur',
    templateUrl: './cause-ko-ok-create-chercheur.component.html',
    styleUrls: ['./cause-ko-ok-create-chercheur.component.css']
})
export class CauseKoOkCreateChercheurComponent implements OnInit {
