...
@Component({
    selector: 'app-template-email-refus-list-chercheur',
    templateUrl: './template-email-refus-list-chercheur.component.html',
    styleUrls: ['./template-email-refus-list-chercheur.component.css']
})
export class TemplateEmailRefusListChercheurComponent implements OnInit {
    // declarations
