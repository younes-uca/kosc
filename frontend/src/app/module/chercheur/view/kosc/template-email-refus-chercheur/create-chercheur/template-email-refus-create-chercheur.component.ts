...
@Component({
    selector: 'app-template-email-refus-create-chercheur',
    templateUrl: './template-email-refus-create-chercheur.component.html',
    styleUrls: ['./template-email-refus-create-chercheur.component.css']
})
export class TemplateEmailRefusCreateChercheurComponent implements OnInit {
