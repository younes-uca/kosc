...
@Component({
    selector: 'app-template-email-refus-view-chercheur',
    templateUrl: './template-email-refus-view-chercheur.component.html',
    styleUrls: ['./template-email-refus-view-chercheur.component.css']
})
export class TemplateEmailRefusViewChercheurComponent implements OnInit {
