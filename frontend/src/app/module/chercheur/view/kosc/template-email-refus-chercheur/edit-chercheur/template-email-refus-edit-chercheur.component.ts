...
@Component({
    selector: 'app-template-email-refus-edit-chercheur',
    templateUrl: './template-email-refus-edit-chercheur.component.html',
    styleUrls: ['./template-email-refus-edit-chercheur.component.css']
})
export class TemplateEmailRefusEditChercheurComponent implements OnInit {
