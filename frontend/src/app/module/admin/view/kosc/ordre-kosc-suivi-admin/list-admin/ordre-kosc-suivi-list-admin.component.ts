...
// }
    ...
    public async loadTemplateEmailClientInjoinableKosc() {
        await this.roleService.findAll();
        const isPermistted = await this.roleService.isPermitted('OrdreKosc', 'list');
        isPermistted ? this.templateEmailClientInjoinableKoscService.findAll().subscribe(templateEmailKoscs => this.templateEmailClientInjoinableKoscs = templateEmailKoscs, error => console.log(error))
            : this.messageService.add({severity: 'error', summary: 'Erreur', detail: 'Problème de permission'});
    ...
    prepareColumnExport(): void {
        ...
        this.criteriaData = [{
            ...
            'Objet client': this.searchOrdreKosc.objetClientInjoinable ? this.searchOrdreKosc.objetClientInjoinable : environment.emptyForExport,
            'Corps client': this.searchOrdreKosc.corpsClientInjoinable ? this.searchOrdreKosc.corpsClientInjoinable : environment.emptyForExport,
            'Envoye client': this.searchOrdreKosc.envoyeClientInjoinable ? (this.searchOrdreKosc.envoyeClientInjoinable ? environment.trueValue : environment.falseValue) : environment.emptyForExport,
            'Date envoi client Min': this.searchOrdreKosc.dateEnvoiClientInjoinableMin ? this.datePipe.transform(this.searchOrdreKosc.dateEnvoiClientInjoinableMin, this.dateFormat) : environment.emptyForExport,
            'Date envoi client Max': this.searchOrdreKosc.dateEnvoiClientInjoinableMax ? this.datePipe.transform(this.searchOrdreKosc.dateEnvoiClientInjoinableMax, this.dateFormat) : environment.emptyForExport,
            ...
            'Objet kosc': this.searchOrdreKosc.objetClientInjoinableKosc ? this.searchOrdreKosc.objetClientInjoinableKosc : environment.emptyForExport,
            'Corps kosc': this.searchOrdreKosc.corpsClientInjoinableKosc ? this.searchOrdreKosc.corpsClientInjoinableKosc : environment.emptyForExport,
            'Envoye kosc': this.searchOrdreKosc.envoyeClientInjoinableKosc ? (this.searchOrdreKosc.envoyeClientInjoinableKosc ? environment.trueValue : environment.falseValue) : environment.emptyForExport,
            'Date envoi kosc Min': this.searchOrdreKosc.dateEnvoiClientInjoinableKoscMin ? this.datePipe.transform(this.searchOrdreKosc.dateEnvoiClientInjoinableKoscMin, this.dateFormat) : environment.emptyForExport,
            'Date envoi kosc Max': this.searchOrdreKosc.dateEnvoiClientInjoinableKoscMax ? this.datePipe.transform(this.searchOrdreKosc.dateEnvoiClientInjoinableKoscMax, this.dateFormat) : environment.emptyForExport,
