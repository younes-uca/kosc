...
@Component({
    selector: 'app-template-email-cri-edit-admin',
    templateUrl: './template-email-cri-edit-admin.component.html',
    styleUrls: ['./template-email-cri-edit-admin.component.css']
})
export class TemplateEmailCriEditAdminComponent implements OnInit {
