...
@Component({
    selector: 'app-template-email-cri-create-admin',
    templateUrl: './template-email-cri-create-admin.component.html',
    styleUrls: ['./template-email-cri-create-admin.component.css']
})
export class TemplateEmailCriCreateAdminComponent implements OnInit {
