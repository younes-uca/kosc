...
@Component({
    selector: 'app-template-email-cri-view-admin',
    templateUrl: './template-email-cri-view-admin.component.html',
    styleUrls: ['./template-email-cri-view-admin.component.css']
})
export class TemplateEmailCriViewAdminComponent implements OnInit {
