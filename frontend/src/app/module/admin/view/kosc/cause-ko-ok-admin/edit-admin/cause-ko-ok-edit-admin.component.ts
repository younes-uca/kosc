...
@Component({
    selector: 'app-cause-ko-ok-edit-admin',
    templateUrl: './cause-ko-ok-edit-admin.component.html',
    styleUrls: ['./cause-ko-ok-edit-admin.component.css']
})
export class CauseKoOkEditAdminComponent implements OnInit {
