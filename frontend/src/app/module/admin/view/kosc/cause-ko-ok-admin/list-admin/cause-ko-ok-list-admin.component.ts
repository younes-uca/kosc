...
@Component({
    selector: 'app-cause-ko-ok-list-admin',
    templateUrl: './cause-ko-ok-list-admin.component.html',
    styleUrls: ['./cause-ko-ok-list-admin.component.css']
})
export class CauseKoOkListAdminComponent implements OnInit {
    // declarations
