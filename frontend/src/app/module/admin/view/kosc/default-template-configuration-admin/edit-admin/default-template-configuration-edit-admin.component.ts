...
@Component({
    selector: 'app-default-template-configuration-edit-admin',
    templateUrl: './default-template-configuration-edit-admin.component.html',
    styleUrls: ['./default-template-configuration-edit-admin.component.css']
})
export class DefaultTemplateConfigurationEditAdminComponent implements OnInit {
