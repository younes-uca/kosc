...
@Component({
    selector: 'app-template-email-confirmation-client-edit-admin',
    templateUrl: './template-email-confirmation-client-edit-admin.component.html',
    styleUrls: ['./template-email-confirmation-client-edit-admin.component.css']
})
export class TemplateEmailConfirmationClientEditAdminComponent implements OnInit {
