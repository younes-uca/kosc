...
@Component({
    selector: 'app-template-email-confirmation-client-view-admin',
    templateUrl: './template-email-confirmation-client-view-admin.component.html',
    styleUrls: ['./template-email-confirmation-client-view-admin.component.css']
})
export class TemplateEmailConfirmationClientViewAdminComponent implements OnInit {
