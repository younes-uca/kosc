...
@Component({
    selector: 'app-source-replanification-list-admin',
    templateUrl: './source-replanification-list-admin.component.html',
    styleUrls: ['./source-replanification-list-admin.component.css']
})
export class SourceReplanificationListAdminComponent implements OnInit {
    // declarations
