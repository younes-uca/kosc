...
@Component({
    selector: 'app-template-email-client-injoinable-kosc-list-admin',
    templateUrl: './template-email-client-injoinable-kosc-list-admin.component.html',
    styleUrls: ['./template-email-client-injoinable-kosc-list-admin.component.css']
})
export class TemplateEmailClientInjoinableKoscListAdminComponent implements OnInit {
    // declarations
