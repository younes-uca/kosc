...
INSERT INTO `arret_travail` (`id`, `comment`, `date_debut`, `date_fin`, `raison_arret_travail`, `technicien`)
VALUES (10000, NULL, '2022-11-12', '2022-11-19', 10000, 2),
...
INSERT INTO `arret_travail_seq` (`next_val`)
VALUES (10003),
       (10003);
...
INSERT INTO `cause_ko_ok` (`id`, `code`, `libelle`)
VALUES (10004, 'client-injoignable', 'Client Injoignable'),
...
INSERT INTO `cause_ko_ok_seq` (`next_val`)
VALUES (10000),
       (10006);
...
INSERT INTO `chercheur` (`id`, `account_non_expired`, `account_non_locked`, `created_at`, `credentials_non_expired`,
                         `email`, `enabled`, `nom`, `password`, `password_changed`, `prenom`, `updated_at`, `username`,
                         `numero_matricule`)
VALUES (129, b'1', b'1', '2022-09-25 15:54:47', b'1', 'chercheur', b'1', NULL,
        '$2a$10$aEQ79HUMED.kUn0rkTUbsOdy/1qubJ9D5KinthQRqyw/3wX5lmnha', b'0', NULL, NULL, NULL, NULL);

--
-- D̩chargement des donn̩es de la table `default_template_configuration`
--

INSERT INTO `default_template_configuration` (`id`, `email_kosc`, `email_maneo`, `enabled`,
                                              `template_email_client_injoinable`,
                                              `template_email_client_injoinable_kosc`, `template_email_cloture`,
                                              `template_email_confirmation_client`, `template_email_cri`,
                                              `template_email_ftl`, `template_email_mauvais_contact`,
                                              `template_email_planification`, `template_email_refus`,
                                              `template_email_replanification`, `template_email_report`,
                                              `template_suivi`)
VALUES (10000, 'kosc@gmail.com', 'maneo.ingenierie@gmail.com', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        NULL, NULL, NULL);
...
INSERT INTO `default_template_configuration_seq` (`next_val`)
VALUES (10000),
       (10001);
...
INSERT INTO `departement` (`id`, `code`, `libelle`, `region`)
VALUES (10000, '001', '001', 10000),
       (10002, '002', '002', 10000),
       (10003, '003', '003', 10000),
       (10004, '004', '004', 10000),
       (10005, '005', '005', 10000),
...
INSERT INTO `departement_seq` (`next_val`)
VALUES (10010),
       (10010);
...
INSERT INTO `departement_technicien` (`id`, `date_debut`, `date_fin`, `departement`, `technicien`)
VALUES (10000, '2022-10-29', '2022-11-29', 10000, 2),
...
INSERT INTO `departement_technicien_seq` (`next_val`)
VALUES (10006),
       (10006);
...
INSERT INTO `entreprise` (`id`, `code`, `libelle`)
VALUES (10000, 'inwi', 'INWI'),
       (10001, 'ORANGE', 'orange');
...
INSERT INTO `entreprise_seq` (`next_val`)
VALUES (10002),
       (10002);
...
INSERT INTO `etat_demande_kosc` (`id`, `code`, `libelle`, `style`)
VALUES (10000, 'ok', 'OK', 'success'),
       (10001, 'ko', 'KO', 'danger'),
...
INSERT INTO `etat_demande_kosc_seq` (`next_val`)
VALUES (10014);
...
INSERT INTO `operator` (`id`, `libelle`, `reference`)
VALUES (10000, NULL, NULL),
       (10001, NULL, NULL),
       (10002, NULL, NULL),
       (10003, NULL, NULL),
       (10004, NULL, NULL);
...
INSERT INTO `operator_seq` (`next_val`)
VALUES (10005),
       (10005);
...
INSERT INTO `raison_arret_travail` (`id`, `code`, `libelle`)
VALUES (10000, 'maladie', 'maladie');

--
-- D̩chargement des donn̩es de la table `raison_arret_travail_seq`
--

INSERT INTO `raison_arret_travail_seq` (`next_val`)
VALUES (10001),
       (10001);
...
INSERT INTO `region` (`id`, `code`, `libelle`)
VALUES (10000, 'marrakech', 'Marrakech');

--
-- D̩chargement des donn̩es de la table `region_seq`
--

INSERT INTO `region_seq` (`next_val`)
VALUES (10001),
       (10001);
...
INSERT INTO `role_app` (`id`, `authority`, `created_at`, `updated_at`)
VALUES (126, 'ROLE_ADMIN', NULL, NULL),
...
INSERT INTO `source_replanification` (`id`, `code`, `libelle`)
VALUES (10000, 'kosc', 'KOSC'),
       (10001, 'client', 'CLIENT'),
...
INSERT INTO `source_replanification_seq` (`next_val`)
VALUES (10000),
       (10003);
...
INSERT INTO `technicien` (`id`, `account_non_expired`, `account_non_locked`, `created_at`, `credentials_non_expired`,
                          `email`, `enabled`, `nom`, `password`, `password_changed`, `prenom`, `updated_at`, `username`,
                          `adresse_ont`, `cell_phone`, `email_attachement`, `identifiant`, `mot_passe`, `entreprise`)
VALUES (2, b'1', b'1', '1970-01-01 00:00:00', b'1', 'khaoula@gmail.com', b'1', 'ait bel mehdi', NULL, b'1', 'khaoula',
        '2022-10-30 23:00:00', NULL, NULL, '0627908006', NULL, 'EE1278015', NULL, 10000),
       (3, b'1', b'1', '1970-01-01 00:00:00', b'1', 'omaima.ziat@gmail.com', b'1', 'ziat', NULL, b'1', 'oumaima ',
        '2022-10-30 23:00:00', NULL, NULL, '0642157894', NULL, 'EE587926', NULL, 10000),
       (4, b'1', b'1', '1970-01-01 00:00:00', b'1', 'zouani@gmail.com', b'1', 'zouani', NULL, b'1', 'younes',
        '2022-10-30 23:00:00', NULL, NULL, '0645879847', NULL, 'EE854972', NULL, 10001);
...
INSERT INTO `template_email_client_injoinable_kosc_seq` (`next_val`)
VALUES (10000),
       (10001);
...
INSERT INTO `template_email_client_injoinable_seq` (`next_val`)
VALUES (10000),
       (10001);
...
INSERT INTO `template_email_cloture_seq` (`next_val`)
VALUES (10000),
       (10000);
...
INSERT INTO `template_email_confirmation_client_seq` (`next_val`)
VALUES (10000),
       (10001);
...
INSERT INTO `template_email_cri_seq` (`next_val`)
VALUES (10000),
       (10000);
...
INSERT INTO `template_email_ftl_seq` (`next_val`)
VALUES (10000),
       (10001);
...
INSERT INTO `template_email_mauvais_contact_seq` (`next_val`)
VALUES (10000),
       (10001);
...
INSERT INTO `template_email_planification_seq` (`next_val`)
VALUES (10000),
       (10001);
...
INSERT INTO `template_email_refus_seq` (`next_val`)
VALUES (10000),
       (10001);
...
INSERT INTO `template_email_replanification_seq` (`next_val`)
VALUES (10000),
       (10001);
...
INSERT INTO `template_email_report_seq` (`next_val`)
VALUES (10000),
       (10001);
...
INSERT INTO `template_suivi_seq` (`next_val`)
VALUES (10000),
       (10000);
...
INSERT INTO `user_app` (`id`, `account_non_expired`, `account_non_locked`, `created_at`, `credentials_non_expired`,
                        `email`, `enabled`, `nom`, `password`, `password_changed`, `prenom`, `updated_at`, `username`)
VALUES (1, b'1', b'1', '2022-10-25 14:01:15', b'1', 'admin', b'1', 'admin',
        '$2a$10$C9vArnf0PhBx9EoV7HlJHeo0xN3dwSmcQadZjpmyJ9F8V6kOlqdBG', b'0', 'admin', NULL, 'admin');
SET
