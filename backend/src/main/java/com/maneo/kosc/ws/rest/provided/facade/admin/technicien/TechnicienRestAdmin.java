...
@GetMapping("/date-rdv/{dateRdv}/code-departement/{codeDepartement}")
    public List<TechnicienVo> findAppropriateTechnecien(@PathVariable String dateRdv , @PathVariable String codeDepartement) {
        Date rdv= DateUtil.parseTimestamp(dateRdv);
        return technicienConverter.toVo(technicienService.findAppropriateTechnicien(rdv, codeDepartement));
    }
