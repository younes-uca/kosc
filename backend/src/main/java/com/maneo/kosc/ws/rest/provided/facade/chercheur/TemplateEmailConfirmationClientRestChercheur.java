...
import com.maneo.kosc.ws.rest.provided.converter.template.TemplateEmailConfirmationClientConverter;
...
@RestController
@RequestMapping("api/chercheur/templateEmailConfirmationClient")
public class TemplateEmailConfirmationClientRestChercheur {
