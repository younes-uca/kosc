...
import com.maneo.kosc.service.admin.facade.template.DefaultTemplateConfigurationAdminService;
...
@RestController
@RequestMapping("api/admin/defaultTemplateConfiguration")
public class DefaultTemplateConfigurationRestAdmin {

    @Autowired
    private DefaultTemplateConfigurationAdminService defaultTemplateConfigurationService;

    @Autowired
    private DefaultTemplateConfigurationConverter defaultTemplateConfigurationConverter;


    @GetMapping("/default/template/configuration")
    public DefaultTemplateConfigurationVo findDefaultTemplateConfiguration() {
        return defaultTemplateConfigurationConverter.toVo(defaultTemplateConfigurationService.findDefaultTemplateConfiguration());
    }
