...
import com.maneo.kosc.bean.Operator;
...
import com.maneo.kosc.service.chercheur.facade.TemplateEmailClientInjoinableChercheurService;
...
public class OrdreKoscChercheurServiceImpl extends AbstractServiceImpl<OrdreKosc> implements OrdreKoscChercheurService {
    ...
    @Autowired
    private TemplateEmailClientInjoinableKoscChercheurService templateEmailClientInjoinableKoscService;
    @Autowired
    private CauseKoOkChercheurService causeKoOkService;
    @Autowired
    ...
    @Autowired
    private TemplateEmailRefusChercheurService templateEmailRefusService;
    @Autowired
    ...
    public OrdreKosc save(OrdreKosc ordreKosc) {
        ...
        if (foundedOrdreKosc == null) {
            ...
            findTemplateEmailConfirmationClient(ordreKosc);
            findTemplateEmailCri(ordreKosc);
            findTemplateEmailFtl(ordreKosc);
            findTemplateEmailClientInjoinable(ordreKosc);
            findTemplateEmailClientInjoinableKosc(ordreKosc);
            findEtatDemandeKosc(ordreKosc);
            findTemplateEmailCloture(ordreKosc);
            findTemplateSuivi(ordreKosc);
            findCauseKoOk(ordreKosc);
            findSourceReplanification(ordreKosc);
